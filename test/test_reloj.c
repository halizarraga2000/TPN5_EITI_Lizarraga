...
2) Configurar la libraria, ajustar la hora (con valores correctos), consultar la hora y tiene que ser valida.
...
4) Simular el paso de n ciclos de reloj, consultar la hora y verificar que avano un segunto.
